...
@interface RCT_EXTERN_MODULE(CryptrReactNative, NSObject)
...
- (void)openInSafari:(NSURL *)URL {
  ...
  NSLog(@"La version actuelle d'iOS est : %@", systemVersion);
...
RCT_EXPORT_METHOD(startAuthentication:(NSURL *)url
